...
namespace FSE.Admin.API.AsyncDataServices
{
    public class MessageBusSubscriber : BackgroundService
    {
        ...
        private void InitializeRabbitMQ()
        {
            ...
            _channel.QueueBind(queue: _queueName, exchange: "fse", routingKey: "");

            Console.WriteLine("--> Listening on the event bus...");
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                Console.WriteLine("--> Profile update event received...");
